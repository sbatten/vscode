...
import { ToggleAutoSaveAction, GlobalNewUntitledFileAction, FocusFilesExplorer, GlobalCompareResourcesAction, SaveAllAction, ShowActiveFileInExplorer, CollapseExplorerView, RefreshExplorerView, CompareWithClipboardAction, NEW_FILE_COMMAND_ID, NEW_FILE_LABEL, NEW_FOLDER_COMMAND_ID, NEW_FOLDER_LABEL, TRIGGER_RENAME_LABEL, MOVE_FILE_TO_TRASH_LABEL, COPY_FILE_LABEL, PASTE_FILE_LABEL, FileCopiedContext, renameHandler, moveFileToTrashHandler, copyFileHandler, pasteFileHandler, deleteFileHandler, cutFileHandler, ShowTestNotificationAction, ShowInfoDialogAction, ShowWarnDialogAction, ShowErrorDialogAction, openFilePreserveFocusHandler, DOWNLOAD_COMMAND_ID, DOWNLOAD_LABEL } from 'vs/workbench/contrib/files/browser/fileActions';
...
registry.registerWorkbenchAction(new SyncActionDescriptor(ShowTestNotificationAction, ShowTestNotificationAction.ID, ShowTestNotificationAction.LABEL), 'Dialog: Show Test Notification', category.value);
registry.registerWorkbenchAction(new SyncActionDescriptor(ShowInfoDialogAction, ShowInfoDialogAction.ID, ShowInfoDialogAction.LABEL), 'Dialog: Show Info Dialog', 'Test');
registry.registerWorkbenchAction(new SyncActionDescriptor(ShowWarnDialogAction, ShowWarnDialogAction.ID, ShowWarnDialogAction.LABEL), 'Dialog: Show Warn Dialog', 'Test');
registry.registerWorkbenchAction(new SyncActionDescriptor(ShowErrorDialogAction, ShowErrorDialogAction.ID, ShowErrorDialogAction.LABEL), 'Dialog: Show Error Dialog', 'Test');
